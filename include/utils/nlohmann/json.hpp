...
#include <utils/nlohmann/detail/json_custom_base_class.hpp>
...
#include <utils/nlohmann/detail/string_concat.hpp>
#include <utils/nlohmann/detail/string_escape.hpp>
#include <utils/nlohmann/detail/string_utils.hpp>
...
namespace std // NOLINT(cert-dcl58-cpp)
{
  ...
  template <>
  struct less<::nlohmann::detail::value_t> // do not remove the space after '<', see https://github.com/utils/nlohmann/json/pull/679
  {
    /*!
