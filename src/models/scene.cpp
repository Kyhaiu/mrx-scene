...
namespace models
{
  ...
  //   std::vector<core::Vector4> vertexes_clipped;
  ...
  //         vectorResult = math::MatrixMultiplyVector(result, v);
  //         vertexes_clipped.push_back(v);

  //         he->getOrigin()->setVectorScreen({vectorResult.x / vectorResult.w, vectorResult.y / vectorResult.w, vectorResult.z / vectorResult.w});
  ...
  //   vertexes_clipped = math::clip3D_polygon(vertexes_clipped);
